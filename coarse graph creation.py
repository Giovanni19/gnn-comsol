...
from training_pressure_multiscale import (
    MultiscalePressureGNN,
    build_coarse_graph
)
...
num_nodes = X_train_pressure.shape[1]
...
print("\n============================================")
print("MULTISCALE PRESSURE GRAPH")
print("============================================")

print("Fine nodes:", num_nodes)
print("Requested clusters:", num_clusters)
